...
var RootCmd = &cobra.Command{
	Use:   "agenda",
	Short: "This is a app for meetings",
	Long: `you can use this app to create or remove meetings.Also you must register a user to have the rights to use the functions.
`,
